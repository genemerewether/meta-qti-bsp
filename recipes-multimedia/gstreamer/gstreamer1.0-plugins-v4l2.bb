...
SUMMARY = "V4l2 Plugins for the GStreamer multimedia"
HOMEPAGE = ""
BUGTRACKER = ""
SECTION = "multimedia"
...
SRC_URI = " \
    git://git.linaro.org/landing-teams/working/qualcomm/pkg/gst-plugins-v4l2.git;protocol=https;branch=debian \
	file://0001-add-changes-for-QTI-HW-decoder.patch \
"
SRCREV = "0d051f538fe00c8a79fcf12a05a6dac3a9af7dd7"
S      =  "${WORKDIR}/git"
